...
public class BankApp {
  ...
  public static void main(String[] args) throws BadAccountException, BadTransactionException{
    greeting();
    usage();
   ...
   */
  private void open() throws IOException, BadAccountException{
...
//Part I:
//depositing a negative amount of money will lead to Error: Tried to deposit less than 0
//deposit to or withdraw from a nonexistent account will lead to an Error: Couldn't find account number, and the program will create an account for you based on your account number
//when the withdraw amount is less than 0, the program does not give an error.

//Part II:
//I put my throw statement in the findAccount method in the VirtualTeller.java

//Extra: 
//we can do that by moving the command = bankApp.readLine("--> "); to the line that is right after the try clause and right before the catch clause.